...
window.onload = function() {
	...
	saveButton.onclick = function() {
		...
		new simpleAjax('edit.php', 'post', "id="+editable.getAttribute("data-id")+"&content="+editable.innerHTML);
		textarea.value = "";
		editor.style.visibility = "hidden";
	};
	...
	for(let i = 0 ; i<document.querySelectorAll(".editable").length ; i++){
			document.querySelectorAll(".editable")[i].onclick = openEditor;
			document.querySelectorAll(".editable")[i].onmouseover = function(){
				this.title = "fermer";
			};
		}
};
